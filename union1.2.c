...
void def_menu() {
    ...
    while (1) {
        ...
        if (opc == 72 && cont > 1) {
            ...
            // Si se ingresó un número, actualiza opc2
            opc2 = opc - '0'; // Convierte el carácter numérico a entero
        }
...
float ingresarNumeroValidado() {
    ...
    while (1) {
        ...
        if (esNumeroValido(entrada)) {
            // Convierte la entrada a un número flotante
            return atof(entrada);
        } else {
            gotoxy(25, 25);
...
void AltaProducto(char nombre[500][20], int id[500], float precio[500], int piezas[500], int *nProducto) {
    ...
    while (1) {
        ...
        while (1) {
            ...
            if (scanf("%i", &id[i]) != 1 || id[i] < 0) {
                gotoxy(28, 14);
                printf(B_RED "Entrada no valida. Por favor ingrese un ID valido." RESET);
                Sleep(2000);
                gotoxy(26, 14);
                printf(B_MAGENTA "                                                    " RESET);
                gotoxy(25, 12);
                printf(B_MAGENTA "                                     " RESET);
                ...
                if (idRepetido) {
                    gotoxy(26, 14);
                    printf(B_RED "El ID ya existe. Por favor ingrese un ID diferente." RESET);
                    Sleep(2000);
                    gotoxy(26, 14);
                    printf(B_MAGENTA "                                                   " RESET);
                    gotoxy(39, 12);
        ...
        while (1) {
            ...
            if (scanf("%f", &precio[i]) != 1 || precio[i] < 0) {
                gotoxy(24, 17);
                printf(B_RED "Entrada no valida. Por favor ingrese un precio valido." RESET);
                Sleep(2000);
                gotoxy(24, 17);
                printf(B_MAGENTA "                                                      " RESET);
                gotoxy(28, 15);
        ...
        // Restricciones para piezas
        while (1) {
            gotoxy(35, 17);
            printf("Inserte cantidad inicial:");
            gotoxy(39, 18);

            if (scanf("%i", &piezas[i]) != 1 || piezas[i] < 0) {
                gotoxy(20, 20);
                printf(B_RED "Entrada no valida. Por favor una cantidad inicial valida." RESET);
                Sleep(2000);
                gotoxy(20, 20);
                printf(B_MAGENTA "                                                         " RESET);
                gotoxy(28, 18);
...
void bajaProducto(char nombre[500][20], int id[500], float precio[500], int piezas[500], int *nProducto) {
    ...
    while (1) {
        ...
        if (indice != -1) {
            ...
            (*nProducto)--;
            gotoxy(35, 16);
            printf(B_GREEN "Producto dado de baja con éxito.\n" RESET);
            gotoxy(30, 18);
            system("pause");
            break;
        } else {
...
void menproduc(){
    ...
    while(1){
        ...
        if (opc4==72 && cont3 > 1){
            ...
            // Si se ingresó un número, actualiza opc2
            opc5 = opc4 - '0'; // Convierte el carácter numérico a entero
        }
...
void EEmpres(char *nombreEmpresa, int *telEmpres, char *correEmpres) {
    ...
    while (1) {
        ...
        gotoxy(30, 14);
        printf("Telefono actual: 33%d", *telEmpres);
        gotoxy(30, 16);
...
void menempres(){
    ...
    SetConsoleTextAttribute(hConsole, 7);
    int cont5 = 1, opc6 = 0;
    char opc7, nombreEmpresa[] = "Ferreteria Tumbada", correEmpres[] = "papusexixd@outlook.com", telEmpres[] = "23988";
    float dcaja=1000;
